                                                                      ...
                                                                      child: StreamBuilder<
                                                                        ...
                                                                        stream:
                                                                          ...
                                                                          queryBuilder: (driverRecord) =>
                                                                            ...
                                                                            'car_plate',
                                                                            isEqualTo:
                                                                                rideDetailsRideRecord.carPlate,
                                                                          ),
                                                                          singleRecord:
                                                                              true,
                                                                        ),
                                                                        builder:
                                                                          ...
                                                                          final imageDriverRecord = imageDriverRecordList.isNotEmpty
                                                                              ? imageDriverRecordList.first
                                                                              : null;
                                                                          ...
                                                                          return ClipRRect(
                                                                            ...
                                                                            child:
                                                                                Image.network(
                                                                              imageDriverRecord?.imageUrl != null && imageDriverRecord?.imageUrl != '' ? imageDriverRecord!.imageUrl : 'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/ride-driver-56i7br/assets/sjkpqor3sn9m/SignUP.png',
                                                                              width: 44.0,
                                                                              height: 44.0,
                                                                              fit: BoxFit.cover,
                                                                            ),
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            rideDetailsRideRecord.driverPhone,
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          if (isiOS) {
                                                            await launchUrl(
                                                                Uri.parse(
                                                                    "sms:${rideDetailsRideRecord.driverPhone}&body=${Uri.encodeComponent('')}"));
                                                          } else {
                                                            await launchUrl(Uri(
                                                              scheme: 'sms',
                                                              path: rideDetailsRideRecord
                                                                  .driverPhone,
                                                            ));
                                                          }
                                                        },
